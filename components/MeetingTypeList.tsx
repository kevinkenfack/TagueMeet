  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <HomeCard
        ...
        title="Planification"
        description="Planifier la réunion"
      ...
      <HomeCard
        ...
        description="Reunion enregistrer"
      ...
      {!callDetail ? (
        ...
        <MeetingModal
          ...
          buttonText="Copier le lien de réunion"
        />
      )}
      ...
      <MeetingModal
        ...
        onClose={() => setMeetingState(undefined)}
        title="Lancer une réunion."
        className="text-center"
        buttonText="Début de réunion"
        handleClick={createMeeting}
      />
    </section>
  );
